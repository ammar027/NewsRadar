...
const About = () => {
  return (
    <div className="about-container">
      ...
      <p className="about-description">
        Thank you for visiting NewsRadar. We hope you enjoy exploring the news and finding the stories that matter to you. Stay tuned for updates and new features!
      </p>
    </div>
  );
};
